...
def fetch_artifact_props_data():
    ...
    if not os.path.exists(filepath):
        url = (
            "https://raw.githubusercontent.com/mrwan200/"
...
class Generator:
    ...
    def generate(self, rates, point_refer=point_refer, label=""):
    ...
    def _draw_skills(self, base):
        ...
        for i in range(3):
            ...
            paste.paste(
                image, (paste.width // 2 - 25, paste.height // 2 - 25), mask=mask
            )
    ...
    def _draw_level(self, base):
        ...
        base.paste(
            friendship_icon, (42 + int(level_length), 76), mask=friendship_icon_mask
        )
        draw.text(
    ...
    def _draw_weapon_stats(self, base):
        ...
        if weapon.detail.substats:
            ...
            substat_image = Image.open(
                f"{dirname}/assets/emotes/{substat_name}.png"
            ).resize((23, 23))
